...
/**
 * Repository layer. Every admin mutation goes through here, so the storage
 * backend is a single swap point rather than something threaded through the UI.
 *
 * Server-only.
 */
...
/** URL-safe slug, deduped against existing slugs. */
